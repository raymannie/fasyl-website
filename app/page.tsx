          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <div className="w-full bg-gray-50 flex items-center justify-center max-w-[554px] h-[700px] ml-auto clip-Card clip-Card-left-secondary">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <button className="bg-red-600 text-white w-[56px] h-[44px] rounded-full flex items-center justify-center hover:bg-red-700 transition-colors">
                    <FaPlay />
                  </button>
                </div>
              </div>
            ...
            <div>
              ...
              <p className="text-gray-700 mb-8">
                ...
                telecommunications, manufacturing, the public sector, and more.
              </p>
